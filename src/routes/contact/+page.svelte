    ...
    <div class="w-[90%] 2xl:w-[70%] mx-auto pb-20">
        <div class="flex flex-col font-medium gap-6 w-[100%] md:w-[50%] 3xl:bg-white">
            ...
            <h3 class="text-[#b6b5b6] text-2xl">
                Every successful product comes from a good idea. If you come equipped with a powerful vision, our team may be prepared to offer funding and expert freelance work to bring your project to fruition.</h3>
        </div>
    </div>
</section>
    ...
    <div class="w-[90%] 2xl:w-[70%] mx-auto py-20">
        ...
        <div class="flex flex-col gap-8 text-white text-lg">
            ...
            <div class="flex flex-col gap-2">
                <p>Message</p>
                <textarea bind:this={messageInput} id="message" bind:value={message} placeholder="What's up?" name="message" class="resize-none primary-input h-[250px]"></textarea>
                {#if noMessage}
